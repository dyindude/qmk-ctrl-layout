...
led_instruction_t led_instructions[] = {
    //
    //`.id2 = 4278190080, .id3 = 1073741823` //entire underglow layer..
    ...
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB, .id0 = ((1 << LED_ESC) + (1 << LED_HOME)), .id1 = ((1 << LED_LSHIFT) + (1 << LED_TAB) + (1 << LED_W) + (1 << LED_A) + (1 << LED_S) + (1 << LED_D)), .id2=((1 << LED_Z) + (1 << LED_RIGHT)), .r = 225, .g = 150, .b = 225 },
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_USE_ROTATE_PATTERN, .id0 = ~((1 << LED_ESC) + (1 << LED_HOME)), .id1 = ~((1 << LED_LSHIFT) + (1 << LED_TAB) + (1 << LED_W) + (1 << LED_A) + (1 << LED_S) + (1 << LED_D)), .id2 = ~((1 << LED_Z) + (1 << LED_RIGHT)), .id3 = 0xFFFFFFFF},

    //Specific LEDs use the user's selected pattern while all others are off
    //                                                                      32 bit number = 31 LEDs
    //wasd = 4, 20, 21, 22
    //1 << 4 + 1 << 20 + 1 << 21 + 1 << 22
